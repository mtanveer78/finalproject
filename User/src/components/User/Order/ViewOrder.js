...
{order[0]?.status === "delivered" ? 
        ...
        <div className="container">
          ...
          <div className="order-info" >
            ...
            <h5 className="order-date">Placed on {order[0]?.date}</h5>
          </div>
          <div className="order-info" >
            <h4 className="pt-1 pl-1">Deliverd on {order[0]?.date}</h4>
            ...
            <div className="col-md-6 summary-container">
              <div className="summary-wrapper">
                ...
                <div className="summary-section">
                  ...
                  <span className="detail float-right">150</span>
                </div>
                <hr />
                <div className="summary-section">
                  <span className="detail">Total:</span>
                  <span className="detail float-right">{order[0]?.total_price + 150}</span>
                </div>
              </div>
