...
function Productcard(props) {
  ...
  return (
    <>
      ...
      <div className="main-productcard grid-color" >
        <div className="product-grid ">
          <div className="product-image p-2">
            <Link to={`/product/${props.product._id}`} className="image">
              <img className="pic-1" src={`http://localhost:5000/images/${props.product.images[0]}`} alt="" />
              {props.product.images.length > 1 ? <img className="pic-2" src={`http://localhost:5000/images/${props.product.images[1]}`} alt="" /> : ""}
            </Link>
          ...
          <div className="product-content">
            ...
            <h3 className="title"><Link to={`/product/${props.product._id}`}>{props.product.name}</Link></h3>
